...
module AniMonad (fps, frames, unframes, lerp, sigLens, extend, stretch, stretchTo, end, start, Signal, (|~), (~>), Key (Key, Key'), All (All), Ease, svg, Rect (Rect), Circle (Circle), draw, width, height, radius) where
